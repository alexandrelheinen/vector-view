...
- grasp motion is generated by `scripts/grasp_task_controller.py` (task-space IK on Gazebo Harmonic);
...
See [modern grasp controller](docs/modern-grasp-controller.md) for the current motion stack.
